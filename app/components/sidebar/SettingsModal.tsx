                        ...
                        <div className="mt-10 flex flex-col gap-y-8">
                            ...
                            <div>
                                ...
                                <div className="mt-2 flex items-center gap-x-3">
                                    <Image className={"rounded-full"} width={"48"} height={"48"} src={image || currentUser?.image || "/images/placeholder.jpg"} alt={"Avatar"} />
                                    <CldUploadButton options={ { maxFiles: 1 } } onUpload={handleUpload} uploadPreset={"mpravqlf"} >
